...
import { useMe, useLogout } from '../../hooks/user.hook';
...
// ProfileHome is declared below — ProfileStack is exported at the bottom of the file
      ...
      <Animated.View style={{ opacity: fadeIn }}>
        ...
        >
          {isLoggingOut ? (
            ...
            <>
              <Icon name="log-out" size={18} color="#ff6b6b" style={{ marginRight: 10 }} />
